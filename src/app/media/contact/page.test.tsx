/**
 * メディアサイトお問い合わせページのテスト
 * @issue #13 - HubSpotフォーム統合
 */
import { render, screen } from '@testing-library/react'
import { vi, describe, it, expect, beforeEach, afterEach } from 'vitest'
import MediaContactPage from './page'
...
describe('MediaContactPage', () => {
  ...
  it('環境変数が設定されている場合、HubSpotフォームを表示する', () => {
    ...
    process.env.NEXT_PUBLIC_HUBSPOT_MEDIA_FORM_ID = 'form-xyz'
    ...
    expect(form).toHaveAttribute('data-form-id', 'form-xyz')
    expect(form).toHaveAttribute('data-target-id', 'media-contact-form')
  ...
  it('環境変数が設定されていない場合、警告メッセージを表示する', () => {
    ...
    delete process.env.NEXT_PUBLIC_HUBSPOT_MEDIA_FORM_ID
