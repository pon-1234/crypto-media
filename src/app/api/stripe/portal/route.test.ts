...
vi.mock('stripe', () => {
  ...
  ;(
    MockStripe as unknown as { errors: { StripeError: typeof MockStripeError } }
  ).errors = {
...
describe('/api/stripe/portal', () => {
  ...
  beforeEach(() => {
    ...
    ) => Stripe)('test', { apiVersion: '2025-02-24.acacia' })
    mockStripeCreate = stripe.billingPortal.sessions
      .create as typeof mockStripeCreate
