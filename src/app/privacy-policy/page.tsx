    ...
    <main className="min-h-screen">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p className="mb-8">
            Crypto Media（以下「当社」といいます。）は、本ウェブサイト上で提供するサービス（以下「本サービス」といいます。）における、
          ...
          <section className="mb-12">
            ...
            <p>
              当社は、ユーザーが利用登録をする際に氏名、メールアドレス、クレジットカード番号などの個人情報をお尋ねすることがあります。
          ...
          <section className="mb-12">
            ...
            <ol className="list-decimal list-inside space-y-2">
              <li>
                当社は、本人から、個人情報が、利用目的の範囲を超えて取り扱われているという理由、または不正の手段により
                取得されたものであるという理由により、その利用の停止または消去（以下「利用停止等」といいます。）を求められた場合には、
                遅滞なく必要な調査を行います。
              </li>
              <li>
          ...
          <section className="mb-12">
            ...
            <div className="mt-4 p-4 bg-gray-50 rounded">
              <p>社名: Crypto Media</p>
              <p>Eメールアドレス: privacy@cryptomedia.jp</p>
            </div>
          </section>

          <section className="mb-12">
            <h2 className="text-2xl font-semibold mb-4">第11条（Cookie（クッキー）について）</h2>
            <p className="mb-4">
              当社は、本ウェブサイトにおいてCookie（クッキー）を使用しています。
              Cookie（クッキー）とは、ウェブサイトを利用したときに、ブラウザとサーバーとの間で送受信した利用履歴や入力内容などを、
              お客様のコンピュータにファイルとして保存しておく仕組みです。
            </p>
            <h3 className="text-xl font-semibold mb-2">利用目的</h3>
            <p className="mb-4">
              当社は、以下の目的のためCookieを使用しています。
            </p>
            <ul className="list-disc list-inside space-y-2">
              <li>お客様の会員登録情報を保持することで、毎回入力する手間を省くため</li>
              <li>お客様が興味を持っている内容や、当社のサイト上での利用状況をお客様自身に確認していただくため</li>
              <li>お客様が簡単に同じ情報を再入力できるようにするため</li>
              <li>当社のサービスの改善、新サービスの開発のため</li>
              <li>当社のサービスに関連して、個人が特定されない形式で統計データを作成するため</li>
            </ul>
          </section>

          <section className="mb-12">
            <h2 className="text-2xl font-semibold mb-4">第12条（アクセス解析ツールについて）</h2>
            <p className="mb-4">
              当社は、お客様のアクセス傾向を把握するために、「Googleアナリティクス」というアクセス解析ツールを使用しています。
              Googleアナリティクスは、トラフィックデータの収集のためにCookieを使用しています。
              このトラフィックデータは匿名で収集されており、個人を特定するものではありません。
            </p>
            <p>
              この機能はCookieを無効にすることで収集を拒否することが出来ますので、お使いのブラウザの設定をご確認ください。
              Googleアナリティクスの利用規約及びプライバシーポリシーについては、Googleアナリティクスのサイトをご覧ください。
            </p>
          </section>
