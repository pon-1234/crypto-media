    ...
    <main className="min-h-screen">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="prose prose-lg max-w-none">
          <p className="mb-8 text-gray-600">最終更新日: 2024年1月1日</p>

          <p className="mb-8">
            Crypto
            Media（以下「当社」といいます。）は、本ウェブサイト上で提供するサービス（以下「本サービス」といいます。）における、
            ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下「本ポリシー」といいます。）を定めます。
          </p>

          <section className="mb-12">
            <h2 className="mb-4 text-2xl font-semibold">第1条（個人情報）</h2>
            <p>
          ...
          <section className="mb-12">
            ...
            <h3 className="mb-2 text-xl font-semibold">利用目的</h3>
            <p className="mb-4">
              当社は、以下の目的のためCookieを使用しています。
            </p>
            <ul className="list-inside list-disc space-y-2">
              <li>
                お客様の会員登録情報を保持することで、毎回入力する手間を省くため
              </li>
              <li>
                お客様が興味を持っている内容や、当社のサイト上での利用状況をお客様自身に確認していただくため
              </li>
              <li>お客様が簡単に同じ情報を再入力できるようにするため</li>
              <li>当社のサービスの改善、新サービスの開発のため</li>
              <li>
                当社のサービスに関連して、個人が特定されない形式で統計データを作成するため
              </li>
            </ul>
          </section>
